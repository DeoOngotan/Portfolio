...
const BOT_DATABASE = [
  {
    ...
    response: "<b>DigiTrike Sudipen</b> is a smart tricycle booking and fare tracking page. It calculates exact commuter fares based on official municipal distances and geofences to ensure fare transparency. Built with React 18, Tailwind CSS, Leaflet.js, and Capacitor 7. <a href='https://digitrike-rgb.github.io/DigiTrike-Page/' target='_blank' style='text-decoration: underline; font-weight:600; color:var(--accent-blue);'>Visit DigiTrike Page</a>"
  },
  {
    keywords: ["eunoia", "psychological", "appointment", "counseling", "mental", "health", "therapist", "calendar", "intakes", "booking", "reserve", "scheduling"],
    response: "The <b>Psychological Appointment System (EunoiaMind)</b> is a counseling portal offering calendar reservations, therapist schedules, secure client intakes, and science-backed therapeutic games. Built with HTML5, Vanilla ES6+ JavaScript, Tailwind CSS v3, and Firestore database transactions to prevent double-booking. <a href='https://eunoia-psych-appoint.web.app/' target='_blank' style='text-decoration: underline; font-weight:600; color:var(--accent-blue);'>Visit EunoiaMind</a>"
  },
  {
    keywords: ["osas", "student", "affairs", "tagudin", "campus", "guidebook", "handbook", "directory", "organization"],
    response: "The <b>ISPSC OSAS Web Page</b> is the Student Affairs portal for Ilocos Sur Polytechnic State College in Tagudin Campus. It organizes campus organization directories, guidebook handbooks, and announcements. Built with HTML5, CSS3 (using custom variables), and Vanilla JavaScript. <a href='https://osas-ispsc-tagudin.vercel.app/' target='_blank' style='text-decoration: underline; font-weight:600; color:var(--accent-blue);'>Visit OSAS Portal</a>"
  },
  {
    keywords: ["supply", "office", "inventory", "resource", "log", "distribution", "asset", "warehouse", "chart", "telemetry"],
    response: "The <b>ISPSC Supply Office System</b> is a supply management and resource monitoring system designed to manage assets, log departmental requests, and track distributions. Developed using HTML5, Tailwind CSS, Vanilla JavaScript (ES modules), Firebase Suite, Chart.js, and SheetJS/ExcelJS exporters. <a href='https://ispsc-supply-office.web.app/' target='_blank' style='text-decoration: underline; font-weight:600; color:var(--accent-blue);'>Visit Supply Office</a>"
  },
  {
    keywords: ["mari", "english", "suwon", "korea", "academy", "tutoring", "reserve", "curriculum", "lesson"],
    response: "<b>Mari English Academy</b> is a scheduling system built for a premium English tutoring academy in Suwon, South Korea. It handles lesson reservation calendars, parent curriculums, and reviews. Built with HTML5, Vanilla JavaScript (ES6+ modules), Tailwind CSS, and a custom translation engine. <a href='https://mari-english.web.app/' target='_blank' style='text-decoration: underline; font-weight:600; color:var(--accent-blue);'>Visit Mari English</a>"
  },
  {
  ...
  {
    keywords: ["experience", "career", "job", "work", "freelance", "history", "position", "role", "resume", "cv", "past", "dswd", "kalahi", "cidss", "cash for work", "office", "administrative"],
    response: "DEO's experience includes full-stack development, design, and office/tech support support:<br>• <b>Full-Stack Developer</b> (Freelance & Academic, 2025 - Present): Designing and deploying web systems, calendar booking grids (EunoiaMind, Mari English), transit trackers (DigiTrike), and asset monitors (Supply Office) using React, JavaScript, Firebase, and SQL database systems.<br>• <b>Office Assistant & Tech Support</b> (DSWD KALAHI-CIDSS, April - May 2026): 25-day Cash-for-Work program where he enhanced office organization workflows, managed files on Google Drive, spreadsheets, Microsoft Word, Excel, and designed documents using Canva.<br>• Designed print/digital marketing assets in Canva, and leveraged Agentic AI tools (Antigravity, Cursor, Bolt.new, v0) and prompt engineering to optimize backend development workflows."
  },
  {
